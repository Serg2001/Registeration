...
{
    [ApiController]
    [Route("api/otherstudent")]
    public class OtherStudentController : ControllerBase
    {
        private readonly OtherStudentService _service;
        private readonly AppDbContext _context;

        public OtherStudentController(
            OtherStudentService service,
        ...
        /// </summary>
        [HttpPost("save")]
        public async Task<IActionResult> Save([FromBody] OtherStudentDTO dto)
        {
        ...
        [HttpGet("by-id/{id}")]
        public async Task<ActionResult<OtherStudentDTO>> GetById(Guid id)
        {
        ...
        {
            var other = await _context.OtherStudents.FindAsync(id);
            if (other == null)
                return NotFound();
