...
namespace Registeration.Services.OtherPhysicalPersonServices
{
    public class OtherPhysicalPersonService
    {
        private readonly IHttpClientFactory _httpClientFactory;
        private readonly AppDbContext _context;

        public OtherPhysicalPersonService(IHttpClientFactory httpClientFactory, AppDbContext context)
        {
        ...
        /// </summary>
        public async Task SaveAsync(OtherPhysicalPerson other, CancellationToken cancellationToken = default)
        {
            if (other == null)
            {
            ...
            try
            {
                _context.OtherPhysicalPersons.Add(other);
        ...
        /// </summary>
        public async Task<OtherPhysicalPerson?> GetByIdAsync(Guid id, CancellationToken cancellationToken = default)
        {
            try
            {
                var result = await _context.OtherPhysicalPersons.FirstOrDefaultAsync(r => r.Id == id, cancellationToken);
                if (result == null)
                {
        ...
        public async Task<bool> DeleteByIdAsync(Guid id, CancellationToken cancellationToken = default)
        {
            try
            {
                var other = await _context.OtherPhysicalPersons.FirstOrDefaultAsync(r => r.Id == id, cancellationToken);
                if (other == null)
                {
