...
namespace Registeration.Services.OtherStudentServices
{
    public class OtherStudentService
    {
        ...
        public OtherStudentService(IHttpClientFactory httpClientFactory, AppDbContext context)
        {
        ...
        /// </summary>
        public async Task SaveAsync(OtherStudent other, CancellationToken cancellationToken = default)
        {
            if (other == null)
            {
            ...
            try
            {
                _context.OtherStudents.Add(other);
        ...
        /// </summary>
        public async Task<OtherStudent?> GetByIdAsync(Guid id, CancellationToken cancellationToken = default)
        {
            try
            {
                var result = await _context.OtherStudents.FirstOrDefaultAsync(r => r.Id == id, cancellationToken);
                if (result == null)
                {
        ...
        public async Task<bool> DeleteByIdAsync(Guid id, CancellationToken cancellationToken = default)
        {
            try
            {
                var other = await _context.OtherStudents.FirstOrDefaultAsync(r => r.Id == id, cancellationToken);
                if (other == null)
                {
                ...
                _context.OtherStudents.Remove(other);
                await _context.SaveChangesAsync(cancellationToken);
